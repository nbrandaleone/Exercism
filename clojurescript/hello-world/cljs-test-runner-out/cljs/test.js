...
var G__3256 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__3256,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__3256;
}
}));
...
var len__4736__auto___3261 = arguments.length;
var i__4737__auto___3262 = (0);
while(true){
if((i__4737__auto___3262 < len__4736__auto___3261)){
args__4742__auto__.push((arguments[i__4737__auto___3262]));

var G__3263 = (i__4737__auto___3262 + (1));
i__4737__auto___3262 = G__3263;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq3258){
var G__3259 = cljs.core.first.call(null,seq3258);
var seq3258__$1 = cljs.core.next.call(null,seq3258);
var G__3260 = cljs.core.first.call(null,seq3258__$1);
var seq3258__$2 = cljs.core.next.call(null,seq3258__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__3259,G__3260,seq3258__$2);
}));
...
var map__3265 = m;
var map__3265__$1 = (((((!((map__3265 == null))))?(((((map__3265.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3265.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3265):map__3265);
var file = cljs.core.get.call(null,map__3265__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__3265__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__3265__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__3264_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__3264_SHARP_));
...
var temp__5735__auto___3267 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___3267)){
var message_3268 = temp__5735__auto___3267;
cljs.core.println.call(null,message_3268);
} else {
}
...
var temp__5735__auto___3269 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___3269)){
var message_3270 = temp__5735__auto___3269;
cljs.core.println.call(null,message_3270);
} else {
}
...
var output_dir = "cljs-test-runner-out";
var output_dir__$1 = (function (){var G__3271 = output_dir;
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__3273 = exception.stack;
var G__3273__$1 = (((G__3273 == null))?null:clojure.string.split_lines.call(null,G__3273));
var G__3273__$2 = (((G__3273__$1 == null))?null:cljs.core.get.call(null,G__3273__$1,depth));
if((G__3273__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__3273__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__3274 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__3274,(0),null);
var column = cljs.core.nth.call(null,vec__3274,(1),null);
var vec__3277 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__3277,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__3277,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__3277,(2),null);
...
var m__$1 = (function (){var G__3280 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__3284 = (function (){var G__3283 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__3283);
} else {
return G__3283;
}
})();
...
return cljs.core.vary_meta.call(null,G__3285,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e3286){var e = e3286;
var G__3287 = e;
var G__3287__$1 = (((G__3287 instanceof cljs.core.Keyword))?G__3287.fqn:null);
switch (G__3287__$1) {
...
var vec__3289 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__3289,(0),null);
var types = vec__3289;
...
return cljs.core.map.call(null,(function (p__3292){
var vec__3293 = p__3292;
var ns = cljs.core.nth.call(null,vec__3293,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__3293,(1),null);
return (function (){
...
var G__3296 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__3296__$1 = (((G__3296 instanceof cljs.core.Keyword))?G__3296.fqn:null);
switch (G__3296__$1) {
case "async":
...
var seq__3297 = cljs.core.seq.call(null,vars__$1);
var chunk__3298 = null;
var count__3299 = (0);
var i__3300 = (0);
while(true){
if((i__3300 < count__3299)){
var v = cljs.core._nth.call(null,chunk__3298,i__3300);
var temp__5735__auto___3302 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___3302)){
var t_3303 = temp__5735__auto___3302;
each_fixture_fn.call(null,((function (seq__3297,chunk__3298,count__3299,i__3300,t_3303,temp__5735__auto___3302,v,each_fixture_fn,G__3296,G__3296__$1,env,once_fixtures,each_fixtures,vec__3293,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_3303)));
});})(seq__3297,chunk__3298,count__3299,i__3300,t_3303,temp__5735__auto___3302,v,each_fixture_fn,G__3296,G__3296__$1,env,once_fixtures,each_fixtures,vec__3293,ns,vars__$1))
);
} else {
}


var G__3304 = seq__3297;
var G__3305 = chunk__3298;
var G__3306 = count__3299;
var G__3307 = (i__3300 + (1));
seq__3297 = G__3304;
chunk__3298 = G__3305;
count__3299 = G__3306;
i__3300 = G__3307;
...
var temp__5735__auto__ = cljs.core.seq.call(null,seq__3297);
if(temp__5735__auto__){
var seq__3297__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__3297__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__3297__$1);
var G__3308 = cljs.core.chunk_rest.call(null,seq__3297__$1);
var G__3309 = c__4556__auto__;
var G__3310 = cljs.core.count.call(null,c__4556__auto__);
var G__3311 = (0);
seq__3297 = G__3308;
chunk__3298 = G__3309;
count__3299 = G__3310;
...
var v = cljs.core.first.call(null,seq__3297__$1);
var temp__5735__auto___3312__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___3312__$1)){
var t_3313 = temp__5735__auto___3312__$1;
each_fixture_fn.call(null,((function (seq__3297,chunk__3298,count__3299,i__3300,t_3313,temp__5735__auto___3312__$1,v,seq__3297__$1,temp__5735__auto__,each_fixture_fn,G__3296,G__3296__$1,env,once_fixtures,each_fixtures,vec__3293,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_3313)));
});})(seq__3297,chunk__3298,count__3299,i__3300,t_3313,temp__5735__auto___3312__$1,v,seq__3297__$1,temp__5735__auto__,each_fixture_fn,G__3296,G__3296__$1,env,once_fixtures,each_fixtures,vec__3293,ns,vars__$1))
);
} else {
}


var G__3314 = cljs.core.next.call(null,seq__3297__$1);
var G__3315 = null;
var G__3316 = (0);
var G__3317 = (0);
seq__3297 = G__3314;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__3296__$1)].join('')));
