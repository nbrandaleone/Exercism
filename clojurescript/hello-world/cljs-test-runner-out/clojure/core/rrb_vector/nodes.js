...
var G__3329 = (root.arr[(slc - (1))]);
var G__3330 = (shift - (5));
var G__3331 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__3329;
shift = G__3330;
cnt = G__3331;
continue;
...
if((!(r_QMARK_))){
var rngs_3340 = clojure.core.rrb_vector.nodes.ranges.call(null,parent);
var rng0_3341 = (rngs_3340[(0)]);
var new_rngs_3342 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_3343 = (rngs_3340[(32)]);
cljs.core.array_copy.call(null,rngs_3340,(1),new_rngs_3342,(0),(lim_3343 - (1)));

var i_3344 = (0);
while(true){
if((i_3344 < lim_3343)){
(new_rngs_3342[i_3344] = ((new_rngs_3342[i_3344]) - rng0_3341));
...
(new_rngs_3342[(32)] = ((rngs_3340[(32)]) - (1)));

(new_rngs_3342[((rngs_3340[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_3342);
} else {
}
...
while(true){
if((i_3346 <= li)){
(new_rngs[i_3346] = ((new_rngs[(i_3346 - (1))]) + step));
...
var G__3352 = (j_3350 + (1));
var G__3353 = (r_3351 + step);
j_3350 = G__3352;
r_3351 = G__3353;
continue;
} else {
...
var rngs = (((!(reg_QMARK_)))?(function (){var G__3354 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__3354[(0)] = node.arr.length);
...
var arr_3355__$1 = arr;
var shift_3356__$1 = shift;
while(true){
if((shift_3356__$1 === (5))){
if((!(reg_QMARK_))){
(arr_3355__$1[(32)] = rngs);
} else {
}

(arr_3355__$1[(0)] = node);
} else {
var a_3357 = (new Array(len));
var e_3358 = cljs.core.__GT_VectorNode.call(null,null,a_3357);
(arr_3355__$1[(0)] = e_3358);
...
var G__3359 = a_3357;
var G__3360 = (shift_3356__$1 - (5));
arr_3355__$1 = G__3359;
shift_3356__$1 = G__3360;
continue;
}
break;
}
