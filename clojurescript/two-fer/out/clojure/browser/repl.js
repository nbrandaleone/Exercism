...
var seq__1818_1822 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__1819_1823 = null;
var count__1820_1824 = (0);
var i__1821_1825 = (0);
while(true){
if((i__1821_1825 < count__1820_1824)){
var str_1826 = cljs.core._nth.call(null,chunk__1819_1823,i__1821_1825);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1826})));


var G__1827 = seq__1818_1822;
var G__1828 = chunk__1819_1823;
var G__1829 = count__1820_1824;
var G__1830 = (i__1821_1825 + (1));
seq__1818_1822 = G__1827;
chunk__1819_1823 = G__1828;
count__1820_1824 = G__1829;
i__1821_1825 = G__1830;
continue;
} else {
var temp__5735__auto___1831 = cljs.core.seq.call(null,seq__1818_1822);
if(temp__5735__auto___1831){
var seq__1818_1832__$1 = temp__5735__auto___1831;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1818_1832__$1)){
var c__4556__auto___1833 = cljs.core.chunk_first.call(null,seq__1818_1832__$1);
var G__1834 = cljs.core.chunk_rest.call(null,seq__1818_1832__$1);
var G__1835 = c__4556__auto___1833;
var G__1836 = cljs.core.count.call(null,c__4556__auto___1833);
var G__1837 = (0);
seq__1818_1822 = G__1834;
chunk__1819_1823 = G__1835;
count__1820_1824 = G__1836;
i__1821_1825 = G__1837;
continue;
} else {
var str_1838 = cljs.core.first.call(null,seq__1818_1832__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1838})));


var G__1839 = cljs.core.next.call(null,seq__1818_1832__$1);
var G__1840 = null;
var G__1841 = (0);
var G__1842 = (0);
seq__1818_1822 = G__1839;
chunk__1819_1823 = G__1840;
count__1820_1824 = G__1841;
i__1821_1825 = G__1842;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__1847 = script;
goog.object.set(G__1847,"type","text/javascript");

goog.object.set(G__1847,"onload",onload);

goog.object.set(G__1847,"onreadystatechange",onload);

return G__1847;
})();
if((opt_sourceText == null)){
var G__1848 = script__$1;
goog.object.set(G__1848,"src",src);

return G__1848;
} else {
var G__1849 = script__$1;
goog.dom.setTextContent(G__1849,opt_sourceText);
...
var path_1850 = goog.debugLoader_.getPathFromDeps_(src);
goog.object.remove(goog.debugLoader_.written_,path_1850);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1850)].join(''));
} else {
var path_1851 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_1851);

goog.object.remove(goog.dependencies_.written,path_1851);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1851)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__1852 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__1853 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__1853);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__1852);
}})()})));
}));
