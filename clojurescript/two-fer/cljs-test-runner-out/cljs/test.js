...
var G__3591 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__3591,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__3591;
}
}));
...
var len__4736__auto___3596 = arguments.length;
var i__4737__auto___3597 = (0);
while(true){
if((i__4737__auto___3597 < len__4736__auto___3596)){
args__4742__auto__.push((arguments[i__4737__auto___3597]));

var G__3598 = (i__4737__auto___3597 + (1));
i__4737__auto___3597 = G__3598;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq3593){
var G__3594 = cljs.core.first.call(null,seq3593);
var seq3593__$1 = cljs.core.next.call(null,seq3593);
var G__3595 = cljs.core.first.call(null,seq3593__$1);
var seq3593__$2 = cljs.core.next.call(null,seq3593__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__3594,G__3595,seq3593__$2);
}));
...
var file = cljs.core.get.call(null,map__3600__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__3600__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__3600__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__3599_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__3599_SHARP_));
...
var temp__5735__auto___3602 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___3602)){
var message_3603 = temp__5735__auto___3602;
cljs.core.println.call(null,message_3603);
} else {
}
...
var temp__5735__auto___3604 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___3604)){
var message_3605 = temp__5735__auto___3604;
cljs.core.println.call(null,message_3605);
} else {
}
...
var output_dir__$1 = (function (){var G__3606 = output_dir;
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__3608 = exception.stack;
var G__3608__$1 = (((G__3608 == null))?null:clojure.string.split_lines.call(null,G__3608));
var G__3608__$2 = (((G__3608__$1 == null))?null:cljs.core.get.call(null,G__3608__$1,depth));
if((G__3608__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__3608__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__3609 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__3609,(0),null);
var column = cljs.core.nth.call(null,vec__3609,(1),null);
var vec__3612 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__3612,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__3612,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__3612,(2),null);
...
var m__$1 = (function (){var G__3615 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__3615__$1 = (((G__3615 instanceof cljs.core.Keyword))?G__3615.fqn:null);
switch (G__3615__$1) {
case "fail":
...
var G__3619 = (function (){var G__3618 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__3618);
} else {
return G__3618;
}
})();
...
return cljs.core.vary_meta.call(null,G__3620,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e3621){var e = e3621;
var G__3622 = e;
var G__3622__$1 = (((G__3622 instanceof cljs.core.Keyword))?G__3622.fqn:null);
switch (G__3622__$1) {
...
var vec__3624 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__3624,(0),null);
var types = vec__3624;
...
return cljs.core.map.call(null,(function (p__3627){
var vec__3628 = p__3627;
var ns = cljs.core.nth.call(null,vec__3628,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__3628,(1),null);
return (function (){
...
var G__3631 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__3631__$1 = (((G__3631 instanceof cljs.core.Keyword))?G__3631.fqn:null);
switch (G__3631__$1) {
case "async":
...
var seq__3632 = cljs.core.seq.call(null,vars__$1);
var chunk__3633 = null;
var count__3634 = (0);
var i__3635 = (0);
while(true){
if((i__3635 < count__3634)){
var v = cljs.core._nth.call(null,chunk__3633,i__3635);
var temp__5735__auto___3637 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___3637)){
var t_3638 = temp__5735__auto___3637;
each_fixture_fn.call(null,((function (seq__3632,chunk__3633,count__3634,i__3635,t_3638,temp__5735__auto___3637,v,each_fixture_fn,G__3631,G__3631__$1,env,once_fixtures,each_fixtures,vec__3628,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_3638)));
});})(seq__3632,chunk__3633,count__3634,i__3635,t_3638,temp__5735__auto___3637,v,each_fixture_fn,G__3631,G__3631__$1,env,once_fixtures,each_fixtures,vec__3628,ns,vars__$1))
);
} else {
}


var G__3639 = seq__3632;
var G__3640 = chunk__3633;
var G__3641 = count__3634;
var G__3642 = (i__3635 + (1));
seq__3632 = G__3639;
chunk__3633 = G__3640;
count__3634 = G__3641;
i__3635 = G__3642;
...
var temp__5735__auto__ = cljs.core.seq.call(null,seq__3632);
if(temp__5735__auto__){
var seq__3632__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__3632__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__3632__$1);
var G__3643 = cljs.core.chunk_rest.call(null,seq__3632__$1);
var G__3644 = c__4556__auto__;
var G__3645 = cljs.core.count.call(null,c__4556__auto__);
var G__3646 = (0);
seq__3632 = G__3643;
chunk__3633 = G__3644;
count__3634 = G__3645;
...
var v = cljs.core.first.call(null,seq__3632__$1);
var temp__5735__auto___3647__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___3647__$1)){
var t_3648 = temp__5735__auto___3647__$1;
each_fixture_fn.call(null,((function (seq__3632,chunk__3633,count__3634,i__3635,t_3648,temp__5735__auto___3647__$1,v,seq__3632__$1,temp__5735__auto__,each_fixture_fn,G__3631,G__3631__$1,env,once_fixtures,each_fixtures,vec__3628,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_3648)));
});})(seq__3632,chunk__3633,count__3634,i__3635,t_3648,temp__5735__auto___3647__$1,v,seq__3632__$1,temp__5735__auto__,each_fixture_fn,G__3631,G__3631__$1,env,once_fixtures,each_fixtures,vec__3628,ns,vars__$1))
);
} else {
}


var G__3649 = cljs.core.next.call(null,seq__3632__$1);
var G__3650 = null;
var G__3651 = (0);
var G__3652 = (0);
seq__3632 = G__3649;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__3631__$1)].join('')));
