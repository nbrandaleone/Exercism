...
var G__1825 = (node__$1.arr[((i__$1 >> shift__$2) & (31))]);
var G__1826 = (shift__$2 - (5));
node__$1 = G__1825;
shift__$2 = G__1826;
continue;
}
...
var G__1828 = i__$2;
var G__1829 = (node.arr[j]);
var G__1830 = (shift__$1 - (5));
i__$1 = G__1828;
node = G__1829;
shift__$1 = G__1830;
continue;
...
var n_1835 = ret;
var shift_1836__$1 = shift;
while(true){
var arr_1837__$1 = n_1835.arr;
var subidx_1838 = (((cnt - (1)) >> shift_1836__$1) & (31));
if((shift_1836__$1 === (5))){
(arr_1837__$1[subidx_1838] = tail_node);
} else {
var temp__5733__auto___1839 = (arr_1837__$1[subidx_1838]);
if(cljs.core.truth_(temp__5733__auto___1839)){
var child_1840 = temp__5733__auto___1839;
var new_carr_1841 = cljs.core.aclone.call(null,child_1840.arr);
var new_child_1842 = cljs.core.__GT_VectorNode.call(null,root_edit,new_carr_1841);
(arr_1837__$1[subidx_1838] = new_child_1842);

var G__1843 = new_child_1842;
var G__1844 = (shift_1836__$1 - (5));
n_1835 = G__1843;
shift_1836__$1 = G__1844;
continue;
} else {
(arr_1837__$1[subidx_1838] = clojure.core.rrb_vector.trees.new_path.call(null,tail_node.arr,root_edit,(shift_1836__$1 - (5)),tail_node));
}
}
break;
}
...
var shift_1846__$1 = shift;
var node_1847__$1 = node;
while(true){
if((shift_1846__$1 === (0))){
var arr_1848 = node_1847__$1.arr;
(arr_1848[(i & (31))] = val);
} else {
var arr_1849 = node_1847__$1.arr;
var subidx_1850 = ((i >> shift_1846__$1) & (31));
var child_1851 = clojure.core.rrb_vector.nodes.clone.call(null,shift_1846__$1,(arr_1849[subidx_1850]));
(arr_1849[subidx_1850] = child_1851);

var G__1852 = (shift_1846__$1 - (5));
var G__1853 = child_1851;
shift_1846__$1 = G__1852;
node_1847__$1 = G__1853;
continue;
}
break;
}
